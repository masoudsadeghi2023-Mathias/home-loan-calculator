...
translations = {
    ...
    "en": {
        "lang_name": "English 🇬🇧",
        "title": "🏡 Home Purchase Calculator (Sweden)",
        "subtitle": "Mobile‑friendly version — built with Streamlit",

        "price": "Home price (kr)",
        "cash": "Down payment (kr)",
        "loan_auto": "💰 Loan amount (auto‑calculated):",

        "interest": "Mortgage interest rate (%)",
        "years": "Repayment period (years)",
        "monthly_cost": "Monthly housing cost (kr)",
        "pantbrev_exist": "Existing pantbrev (kr)",

        "calculate": "Calculate",
        "results": "Calculation results",
        "monthly_payment": "Monthly loan payment",
        "total_monthly": "Loan + monthly cost",

        "extra_costs": "Additional purchase costs",
        "lagfart": "Stamp duty (Lagfart)",
        "pantbrev": "Mortgage deed (Pantbrev)",
        "extra_total": "Total extra costs:",

        "footer": "Created by Masoud ❤️"
    }
}
...
# Inputs
price = st.number_input(t["price"], min_value=0, value=1000000)
cash = st.number_input(t["cash"], min_value=0, value=100000)
